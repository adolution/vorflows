...
(Mail bestätigen → Fragen → Kalender). Subline darüber: „Damit du am **10.09. um
...
3. **Modal Schritt 1 = Shopify-Gate** „Hast du einen Shopify-Shop?" (Ja/Nein).
   ...
   - „Ja, hab ich" → `lw_qualify_yes` → weiter zu Schritt 2 (`show(2)`, **kein** WJ,
     **kein** Close).
4. **Modal Schritt 2 = Termin-Commit** „Kannst du am 10. September, 11:00 Uhr?" (Termin zentral in `WEBINAR_DATE`) → der
